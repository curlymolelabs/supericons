...
function assertDownloadContract(
  ...
  assert.equal(downloads.summary.parsed.headers.length, 21);
  ...
  assert.ok(downloads.summary.parsed.headers.includes('requested_limit_distribution'));
  ...
  assert.equal(audit.export_schema_version, '4.3');
