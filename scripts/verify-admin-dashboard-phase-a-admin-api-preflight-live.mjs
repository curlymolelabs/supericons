...
const cases = [
  { name: 'healthy', status: 200, body: { stats: {} }, delayMs: 0, expectedExit: 0, expectedStatus: 'ok' },
  { name: 'fast_legacy_5xx', status: 503, body: { error: 'unavailable' }, delayMs: 0, expectedExit: 0, expectedStatus: 'degraded_proceed' },
  { name: 'slow_healthy', status: 200, body: { stats: {} }, delayMs: 350, expectedExit: 1, expectedStatus: 'blocked' },
  { name: 'slow_legacy_5xx', status: 503, body: { error: 'unavailable' }, delayMs: 350, expectedExit: 1, expectedStatus: 'blocked' },
  { name: 'auth_rejected', status: 401, body: { error: 'unauthorized' }, delayMs: 0, expectedExit: 1, expectedStatus: 'blocked' },
];
