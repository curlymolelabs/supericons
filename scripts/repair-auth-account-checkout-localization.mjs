...
const common = {
  en: {
    ...
    'auth.copy.purchase.signin.note': 'We will bring you back so you can continue where you left off.',
    ...
    'auth.copy.purchase.signup.note': 'We will bring you back so you can continue where you left off.',
    ...
    'auth.copy.subscribe.signin.note': 'We will bring you back so you can continue to checkout.',
    ...
    'auth.copy.subscribe.signup.note': 'We will bring you back so you can continue to checkout.',
  ...
  'zh-Hans': {
    ...
    'auth.copy.purchase.signin.note': '我们会带你回到这里，以便继续刚才的操作。',
    ...
    'auth.copy.subscribe.signup.note': '我们会带你回到这里，以便继续结账。',
  ...
  'zh-Hant': {
    ...
    'auth.copy.purchase.signin.note': '我們會帶你回到這裡，方便你繼續剛才的操作。',
    ...
    'auth.copy.subscribe.signup.note': '我們會帶你回到這裡，方便你繼續結帳。',
