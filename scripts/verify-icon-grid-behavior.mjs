...
assert.equal(siIcons.length, 147, 'Supericons library should contain 147 icons in the public index');
...
assert.equal(
  ...
  147,
  'Supericons tag category counts should sum to the full 147-icon library'
);
...
assert.equal(
  ...
  147,
  'public taxonomy snapshot should include all 147 Supericons entries'
);
