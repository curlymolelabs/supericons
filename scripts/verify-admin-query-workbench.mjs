...
[
  ...
  'Diagnostics',
  'intelligenceSignalFilter',
  'Search demand details',
  'queryDetailDrawer',
  'queryDetailContent',
...
[
  ...
  'id="queryExplorerEnvironmentFilter"',
  'id="queryExplorerChannelFilter"',
  'id="queryExplorerPurposeFilter"',
  'id="queryExplorerSort"',
  'id="queryExplorerDirection"',
  'Legacy / unknown',
  'Production only',
  '>Unknown<',
