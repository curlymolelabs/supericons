...
[
  ...
  'fetchDashboardV2HostedFetches',
  ".eq('tool_name', 'get_icon')",
  ".eq('channel', 'hosted_mcp')",
  "query.in('domain', [...getProductionAnalyticsHosts()])",
  'Confirmed Local MCP icon actions are not recorded yet.',
...
[
  ...
  'identity_unavailable_reason',
  'Icon leaderboard needs the v2 summary endpoint.',
  "key === 'icons'",
  'Exact billing price is not linked to every active subscription',
