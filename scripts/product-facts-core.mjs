...
export async function buildProductFactsObject() {
  ...
  return {
    ...
    display: {
      freeIconsRounded,
      freeIconsLabel: `${freeIconsRounded} free icons`,
      freeIconsAcrossLibrariesLabel: `${freeIconsRounded} icons across ${freeLibraryCount} libraries`,
      freeIconsAcrossLibrariesFreeLabel: `${freeIconsRounded} free icons across ${freeLibraryCount} libraries`,
      ...
      mcpServerFreeIconsLabel: `MCP server (${freeIconsRounded} free icons)`,
