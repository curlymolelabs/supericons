...
Your job in this run is to create a screenshot-review batch, write `depicts` for the selected icons, finalize the batch, run the audit, and stop for review.
