...
| `P1` Shared deterministic understanding | Gate C rolled back; local latency Phase 1 correction complete and not deployed | Search intent core, generated rules/graph, shared policy-aware query-frame modules, recommendation clarification, maintained ranking policy, ambiguity diversification, all 50 approved SI brand classifications, rejected-alias enforcement, final-fusion policy enforcement, strict/prefer/all modes, isolated beta endpoint, additive audit contract, safe stage timing, additive SVG-free beta candidate RPC, final-result SVG hydration, clarification-safe aggregation, locale-count helper, prerelease routing, and rollback plan | Deterministic and 225-case checks passed; lightweight RPC parity passed in disposable PostgreSQL 17; response hydration parity passed; earlier live behavior checks passed; new live latency is not verified | The `@supericons/mcp` 0.4.18-beta.0 package dry-run and package checks verified 38 files; not published | Beta measurement schema and version `20260712` remain deployed; the new `20260713150000` migration is local only; isolated beta function remains deleted; production functions remained on versions 34 and 35 at the last live check | Earlier beta behavior was briefly observed through internal Gate C checks, then withdrawn; Phase 1 correction has not been observed live | `references/verification/search-v2-latency-phase1-local-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-gate-c-rollback-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-gate-b-execution-2026-07-13.md`; `references/verification/search-v2-hosted-migration-inventory-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-migration-smoke-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-gate-a-2026-07-12.md` |
...
2. Review the local Phase 1 timing, lightweight candidate, and response-parity evidence.
3. Prepare a guarded exact-SQL apply plan and a new Gate A approval packet. Keep cold and warm samples separate in the later live gate.
