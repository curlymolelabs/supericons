...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `P0` Governance and baseline | In progress; traceability complete, candidate suite expanded, remaining legacy/library scoring and target expansion open | Official specification version 1.1; sanitized July 11 baseline; 71-case candidate evaluation suite toward the 225-case target | Traceability audit passed; 71-case schema and review-status checks passed; all 12 July meaning seeds and all 10 ambiguity/brand policy cases are owner-reviewed; 15 library cases and 28 legacy cases remain open | Not applicable | Not applicable | Not applicable | `docs/si-v2/search/consolidation-traceability.md`; `references/verification/search-query-baseline-2026-07-11.md`; `references/verification/search-v2-evaluation-expansion-2026-07-11.md`; `references/verification/search-v2-ambiguity-policy-2026-07-11.md`; `references/verification/search-ranking-policy-2026-07-11.md` |
| `P1` Shared deterministic understanding | Partially implemented and locally verified | Search intent core, generated rules/graph, shared query-frame modules, opt-in `include_query_frame`, recommendation query-frame hooks, maintained ranking policy, ambiguous search diversification, and generic brand-intent gating in local and hosted ranking code | Ranking policy verification passed for `hello`, contextual hello, `swift`, `picker`, `magnifier`, exact HelloFresh identity, and hosted synthetic candidates; query-frame classification and recommendation clarification remain incomplete | MCP package build was verified in the saved query-frame record; the new ranking slice was not packaged | Not deployed | Not observed live | `references/verification/semantic-search-v2-intent-graph-phase-1-2026-07-01.md`; `references/verification/semantic-search-v2-query-frame-shadow-2026-07-01.md`; `references/verification/search-ranking-policy-2026-07-11.md` |
...
The July 11 candidate suite contains 71 cases: 28 legacy seeds pending owner confirmation, 12 owner-reviewed July meaning seeds, 15 library contract seeds pending owner scoring, 6 cross-surface contract cases, and 10 owner-reviewed ambiguity/brand policy cases. Current in-memory verification generated 75,810 documents from the current workspace inputs and did not replace the saved July 1 output artifact.
...
1. Owner-confirm the 28 legacy seeds and score the 15 library candidate expectations.
...
5. Add recommendation clarification behavior and its public MCP contract description.
