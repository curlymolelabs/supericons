...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `P0` Governance and baseline | In progress; traceability complete, candidate suite expanded, owner scoring and target expansion open | Official specification version 1.1; sanitized July 11 baseline; 71-case candidate evaluation suite toward the 225-case target | Traceability audit passed; 71-case schema and review-status checks passed; 12 July seeds, 15 library cases, 6 cross-surface cases, and 10 ambiguity/brand policy cases are recorded; owner scoring is not recorded | Not applicable | Not applicable | Not applicable | `docs/si-v2/search/consolidation-traceability.md`; `references/verification/search-query-baseline-2026-07-11.md`; `references/verification/search-v2-evaluation-expansion-2026-07-11.md`; `references/verification/search-v2-ambiguity-policy-2026-07-11.md` |
| `P1` Shared deterministic understanding | Partially implemented | Search intent core, generated rules/graph, shared query-frame modules, opt-in `include_query_frame`, recommendation query-frame hooks; ambiguity and brand-gating behavior specified but not implemented | Intent graph, semantic smoke, recommendation modes, and expanded search/recommendation query-frame contract passed; all 12 July seed frames and all 6 ambiguity policy frames remain unclassified | MCP package build was verified in the saved query-frame record; no publication proved | Not verified; saved record says no Supabase/Netlify deploy | Not verified | `references/verification/semantic-search-v2-intent-graph-phase-1-2026-07-01.md`; `references/verification/semantic-search-v2-query-frame-shadow-2026-07-01.md`; `references/verification/search-v2-evaluation-expansion-2026-07-11.md`; `references/verification/search-v2-ambiguity-policy-2026-07-11.md` |
...
The July 11 candidate suite contains 71 cases: 28 legacy seeds pending owner confirmation, 12 public-safe July seeds pending owner scoring, 15 library contract seeds pending owner scoring, 6 cross-surface contract cases, and 10 ambiguity/brand policy seeds pending owner scoring. Current in-memory verification generated 75,810 documents from the current workspace inputs and did not replace the saved July 1 output artifact.
...
5. Define maintained interpretation-family and brand-term classifications, then add ambiguity and brand-collision ranking assertions.
