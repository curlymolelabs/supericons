...
| `P1` Shared deterministic understanding | Gate C rolled back; latency measurement Gate A prepared and awaiting approval | Search intent core, generated rules/graph, shared policy-aware query-frame modules, recommendation clarification, maintained ranking policy, ambiguity diversification, all 50 approved SI brand classifications, rejected-alias enforcement, final-fusion policy enforcement, strict/prefer/all modes, isolated beta endpoint, additive audit contract, safe stage timing, approximate candidate payload measurement, additive SVG-free beta candidate RPC, final-result SVG hydration, exact control/treatment commits, guarded SQL runner, clarification-safe aggregation, locale-count helper, prerelease routing, and rollback plan | Deterministic and 225-case checks passed; exact handler HTTP parity passed for five cases; lightweight RPC preflight, postflight, permission, parity, and rollback checks passed in disposable PostgreSQL 17; new live latency is not verified | The `@supericons/mcp` 0.4.18-beta.0 package dry-run and package checks verified 38 files; not published | Beta measurement schema and version `20260712` remain deployed; migration `20260713150000` remains local only; isolated beta function remains deleted; production functions remained on versions 34 and 35 at the last live check | Earlier beta behavior was briefly observed through internal Gate C checks, then withdrawn; the prepared control and treatment have not been observed live | `references/verification/search-v2-latency-gate-a-preparation-2026-07-13.md`; `references/verification/search-v2-latency-phase1-local-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-gate-c-rollback-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-gate-b-execution-2026-07-13.md`; `references/verification/search-v2-hosted-migration-inventory-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-migration-smoke-2026-07-13.md`; `references/verification/search-v2-deterministic-mcp-beta-gate-a-2026-07-12.md` |
...
2. Review the local Gate A preparation evidence and authorization manifest.
3. Obtain explicit owner approval for fingerprint `fcdfaeef7f19af49536438ca1518655813fcffd103866d352cdb792c6821bb25` before any hosted mutation.
