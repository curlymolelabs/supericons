...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `P0` Governance and baseline | Complete for the approved fixed-suite scope | Official specification version 1.4; sanitized July 11 baseline; 225-case evaluation suite; approved legacy, SI-brand, and multilingual meaning reviews | Traceability audit passed; all 225 cases have stable IDs; 219 cases are owner-reviewed and 6 are contract fixtures; multilingual language assurance remains automated high confidence without claiming native review | Not applicable | Not applicable | Not applicable | `docs/si-v2/search/consolidation-traceability.md`; `docs/si-v2/search/reviews/multilingual-evaluation-owner-review-2026-07-12.md`; `references/verification/search-v2-sample-executor-gate-2026-07-12.md`; `references/verification/search-v2-multilingual-gate-and-sample-plan-2026-07-12.md`; `references/verification/search-query-baseline-2026-07-11.md` |
...
| `P3` Offline embeddings | Exact sample executor implemented and authorized; live sample blocked by missing environment credentials | Provider-neutral candidate config, Gemini Embedding 2 E3, no-network corpus plan/dry-run modes, fixed 12-input sample, provider adapters, response validation, a fingerprint-bound no-retry executor, and a local replay-blocking ledger; no corpus embedding generation, sync adapter, or vector-storage migration | Corpus plan/dry run passed for 75,810 English documents; mock execution made exactly eight requests; wrong fingerprint, wrong cap, missing-key, concurrent, completed-replay, and partial-replay checks made zero unauthorized requests; synthetic provider failure was not retried; no live provider response or retrieval quality tested | Not applicable | Not verified | Not verified | `references/verification/search-v2-sample-executor-gate-2026-07-12.md`; `references/verification/search-v2-multilingual-gate-and-sample-plan-2026-07-12.md`; `docs/si-v2/search/experiments/offline-embedding-sample-contract-2026-07-12.md`; `docs/si-v2/search/reviews/embedding-sample-authorization-request-2026-07-12.md` |
...
| `P3` | Corpus planning and the exact no-retry sample executor exist. The live sample awaits three provider environment variables; corpus embedding, storage, and rollback execution are not implemented. |
