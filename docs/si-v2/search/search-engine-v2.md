...
| `FR-52` | Railway hosted `search_icons` and the public Railway search endpoint use the established hosted variant engine first. The packaged engine may recover a valid hosted no-result, but it cannot hide a hosted dependency error. `recommend_icons` remains local-first. Responses and telemetry distinguish `hosted` from `local_fallback`, and the public endpoint continues to omit SVG and protected semantic data. | `G-01`, `G-02`, `G-03`, `G-07`, `FR-16`, `FR-21`, `FR-24`, `FR-48`, `D-036` | The exact candidate and live deployment pass judged agent-style multiword relevance and forbidden-result checks, strict-library and multilingual cases, honest no-results, MCP-to-public-HTTP ordered-reference parity, browser-safe payload checks, agent-readable errors, preview and recommendation regressions, the fixed 225-case suite, and rollback verification. |
