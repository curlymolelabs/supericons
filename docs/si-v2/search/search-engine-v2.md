...
| `FR-47` | A recommendation prerelease must complete before the 20-second client timeout. Warm end-to-end p95 must be at most 3 seconds for 1 slot, 10 seconds for 10 slots, and 15 seconds for 20 slots, with zero client timeouts in the approved workload. | Agent reliability, `FR-35`, `FR-38`, `D-031` | The exact candidate bytes pass public-safe warm measurements for 1, 10, and 20 resolved slots, including one supported non-English 20-slot case. Any miss blocks publication. |
