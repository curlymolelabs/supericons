...
# Windows
claude mcp add supericons -- cmd /c npx -y @supericons/mcp@latest`,
      },
    ],
...
Then insert the chosen SVG into my React component.`,
    ...
    troubleshootingCards: [
      ...
      },
      {
        ...
        copy: 'On native Windows, use <code>cmd /c npx -y @supericons/mcp@latest</code> instead of calling <code>npx</code> directly.',
      },
      {
    ...
    snippets: [
      {
        id: 'codex-config',
        label: 'Copy',
        code: 'codex mcp add supericons -- npx -y @supericons/mcp@latest',
      },
      {
    ...
    flowCards: [
      {
        ...
        copy: 'Run <code>codex mcp add supericons -- npx -y @supericons/mcp@latest</code> or add the same values to <code>config.toml</code>.',
      },
      {
