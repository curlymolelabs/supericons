...
export function rerankHostedSearchCandidates(
  ...
  const expressiveFallbackPenaltyByIcon = new Map();
  const ranked = candidates
    .map((candidate) => {
      ...
      const expressiveFallbackPenalty = getExpressiveFallbackPenalty(queryNorm, candidate);
      expressiveFallbackPenaltyByIcon.set(candidate.icon_id, expressiveFallbackPenalty);
      ...
      return {
        ...
        match_signals: {
          ...
          expressive_fallback_penalty: expressiveFallbackPenalty,
        },
      };
    })
    .sort((a, b) => (
