/**
 * Shared public search pipeline used by local npm and the built web app.
 * Candidate data is injected by each surface.
 */
import { expandCjkQuery, normalizeCjkSearchText } from './cjk-search-core.js';
import { createIconSemanticAliasMap } from './icon-semantic-aliases.js';
import { createIconTaxonomyMap } from './icon-taxonomy-seed.js';
import {
...
} from './search-intent-core.js';
import { buildSearchQueryFrame } from './search-query-frame.js';
import {
...
export function searchIcons(query, icons, synonyms, options = {}) {
  ...
  const cjkExpansion = expandCjkQuery(query, {
    ...
    terms: options.multilingualExpansionTerms || [],
  });
